...
5. **Детальная информация** о каждом покемоне:
   - Основные характеристики (HP, Attack, Defense и тд)
   - Типы покемона
   - Способности
...
### Карточка с информацией о покемоне

<img src="./readme_images/pokemon_details.jpg" alt="Главный экран" height="400px" />
